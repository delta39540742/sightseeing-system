...
const { getQuery, AN_GIANG_BBOX, OVERPASS_URL } = require('./overpass_queries');

async function fetchOSMData() {
    const query = getQuery(AN_GIANG_BBOX);
    
    console.log("Fetching OSM data for An Giang... This might take a minute.");
    ...
    try {
        ...
        const outPath = path.join(dataDir, 'raw_an_giang_osm.json');
