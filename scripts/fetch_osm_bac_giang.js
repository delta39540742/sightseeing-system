...
const { getQuery, BAC_GIANG_BBOX, OVERPASS_URL } = require('./overpass_queries');

async function fetchOSMData() {
    const query = getQuery(BAC_GIANG_BBOX);
    
    console.log("Fetching OSM data for Bac Giang... This might take a minute.");
    ...
    try {
        ...
        const outPath = path.join(dataDir, 'raw_bac_giang_osm.json');
